...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "fixed grid place-items-center overflow-y-auto inset-0 z-50 bg-black/50",
    ...
    <DialogPortal data-slot="dialog-portal">
      <DialogOverlay>
        <DialogPrimitive.Content
          ...
          className={cn(
            "relative z-50 grid w-full max-w-[95vw] max-h-[95vh] overflow-y-auto",
            "bg-background shadow-lg rounded-lg border",
            "data-[state=open]:animate-in data-[state=closed]:animate-out",
            "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
            "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
            "duration-200 p-6 gap-4",
            // Responsive styles
            "max-[730px]:rounded-none max-[730px]:h-full",
            "max-[900px]:w-[600px] max-[900px]:h-full",
            "min-[900px]:w-[680px] min-[900px]:max-h-[700px]",
            className
          )}
          {...props}
        >
